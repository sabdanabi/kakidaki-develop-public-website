<template>
 ...
 : 'border-slate-200 focus:border-[#023C23] focus:ring-[#023C23]/20'
 ]"
 />
 </div>
 <p v-if="form.email.length > 0 && !isEmailValid"class="mt-1.5 flex items-center gap-1.5 text-xs text-red-500">
 ...
 <div class="flex items-center gap-2 text-xs":class="hasNumber ? 'text-[#023C23]' : 'text-red-500'">
 ...
 <div class="flex items-center gap-2 text-xs":class="hasSpecial ? 'text-[#023C23]' : 'text-red-500'">
 ...
 <p class="flex items-center gap-2 text-xs text-red-500">
 ...
 Sudah punya akun?
 <NuxtLink to="/login"class="font-medium text-[#023C23] transition-colors hover:text-emerald-600">
 Masuk
 </NuxtLink>
 </p>
 </div>
 ...
 />
 <div class="absolute inset-0 bg-gradient-to-b from-red-900/90 via-slate-900/85 to-[#023C23]/90"></div>
...
"Dengan Kaki Daki, tim kami bisa mengambil keputusan Go/No-Go lebih cepat dan tepat. Data real-time yang disajikan sangat membantu operasional kami."
 ...
 <div class="flex h-12 w-12 items-center justify-center rounded-full bg-white/15 text-lg font-medium text-white">
 Kd
 </div>
 <div>
 <p class="font-medium text-white">Kaki Daki Admin</p>
 ...
 <div>
 <p class="mb-4 text-xs font-medium text-white/40">Dipercaya oleh</p>
 <div class="flex flex-wrap items-center gap-3">
 <span class="rounded-md bg-white/10 px-4 py-2 text-xs font-medium text-white/70 backdrop-blur-sm">Partner A</span>
 <span class="rounded-md bg-white/10 px-4 py-2 text-xs font-medium text-white/70 backdrop-blur-sm">Partner B</span>
 <span class="rounded-md bg-white/10 px-4 py-2 text-xs font-medium text-white/70 backdrop-blur-sm">Partner C</span>
 </div>
 </div>
 </div>
 </div>
